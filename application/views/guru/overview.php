                ...
                <div class="col-lg-12 col-xl ">
                    <div class="panel panel-default">
						...
						foreach($data2->result_array() as $i):
							...
							$email=$i['email'];
							?>
													<form method="post" role="form" action="<?php echo base_url().'index.php/guru/overview/edit_user'?>">
														...
														<div class="form-group">
															<b><label>Bidang</b>
															<input name="name" disabled	 class="form-control" placeholder="Enter text" value="<?php echo $bidang;?>">
														</div>
														<div class="form-group">
                        ...
                        <div class="panel-body">
                            <div class="row">
								...
								<b><label>Upload Photo Profile	</label></b><br>
														...
														<?php echo form_open_multipart('guru/overview/aksi_upload');?>
